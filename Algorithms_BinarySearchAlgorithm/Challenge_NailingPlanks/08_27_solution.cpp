...
bool enoughNails(const std::vector<int>& A, const std::vector<int>& B,
...
int solution(std::vector<int>& A, std::vector<int>& B, std::vector<int>& C)
{
	int maxValBoards = *std::max_element(B.begin(), B.end()),
	    maxValNails = *std::max_element(C.begin(), C.end());
...
inline bool enoughNails(const std::vector<int>& A, const std::vector<int>& B,
			const std::vector<int>& nails)
{
